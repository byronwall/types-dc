...
declare namespace dc {
  ...
  export interface BaseMixin<T> {
    ...
    filterAll(): void;
    select(
      selector: d3.Selection<any, any, any, any> | string
    ): d3.Selection<any, any, any, any>;
    selectAll(
      selector: d3.Selection<any, any, any, any> | string
    ): d3.Selection<any, any, any, any>;
    anchor(
      anchor: BaseMixin<any> | d3.Selection<any, any, any, any> | string,
      chartGroup?: string
    ): d3.Selection<any, any, any, any>;
    anchorName(): string;
    svg: IGetSet<
  ...
  export interface CoordinateGridMixin<T>
    ...
    xAxis: IGetSet<d3.Axis<number>, T>;
    ...
    yAxis: IGetSet<d3.Axis<number>, T>;
  ...
  export interface StackMixin<T> {
    ...
    // TODO: stackLayout: IGetSet<d3.layout.Stack<any[], any>, T>;
  }
  ...
  export interface ICompositeChart<T> extends CoordinateGridMixin<T> {
    ...
    rightYAxis: IGetSet<d3.Axis<number>, ICompositeChart<T>>;
  }
  ...
  export interface GeoChoroplethChart
    ...
    // TODO: projection: IGetSet<d3.geo.Projection, GeoChoroplethChart>;
    geoJsons(): Array<GeoChoroplethLayer>;
    //TODO: geoPath(): d3.geo.Path;
  ...
  export interface RowChart
    ...
    xAxis: IGetSet<d3.Axis<number>, RowChart>;
  ...
  */
  ...
  export  interface Base {
    ...
    transition(
      ...
      duration: number,
      callback: (s: d3.Selection<any, any, any, any>) => void
    ): void;
